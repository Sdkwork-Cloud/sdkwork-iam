...
function printHelp() {
  console.log(`Usage: node run-renderer-dev-with-bootstrap.mjs [options] [--] [command ...]
...
Examples:
  node run-renderer-dev-with-bootstrap.mjs -- vite --host 127.0.0.1 --port 5174
  node run-renderer-dev-with-bootstrap.mjs --cwd apps/sdkwork-mall-h5 -- vite
`);
}
