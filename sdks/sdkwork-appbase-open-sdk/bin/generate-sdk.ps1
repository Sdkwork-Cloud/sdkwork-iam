...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/appbase-open-sdk" }
        "dart" { return "sdkwork_appbase_open_sdk" }
        "flutter" { return "sdkwork_appbase_open_sdk" }
        "python" { return "sdkwork-appbase-open-sdk" }
        "go" { return "github.com/sdkwork/sdkwork-appbase-open-sdk" }
        "java" { return "com.sdkwork:sdkwork-appbase-open-sdk" }
        "kotlin" { return "com.sdkwork:sdkwork-appbase-open-sdk" }
        "swift" { return "sdkwork-appbase-open-sdk" }
        "csharp" { return "SDKWork.Appbase.OpenSdk" }
        "rust" { return "sdkwork-appbase-open-sdk" }
        "php" { return "sdkwork/appbase-open-sdk" }
        "ruby" { return "sdkwork-appbase-open-sdk" }
        default { return "sdkwork-appbase-open-sdk-$Language" }
    }
}
...
function Resolve-NamespaceArgs {
    ...
    switch ($Language) {
        "java" { return @("--namespace", "com.sdkwork.appbase.open.sdk") }
        "kotlin" { return @("--namespace", "com.sdkwork.appbase.open.sdk") }
        "csharp" { return @("--namespace", "SDKWork.Appbase.OpenSdk") }
        "php" { return @("--namespace", "SDKWork\Appbase\OpenSdk") }
        default { return @() }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-appbase-open-api.sdkgen.yaml"
$SdkName = "sdkwork-appbase-open-sdk"
$ApiPrefix = "/iam/v3/api"
