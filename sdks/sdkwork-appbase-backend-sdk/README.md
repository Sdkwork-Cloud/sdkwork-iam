...
This SDK family is generated from the `sdkwork-appbase-backend-api` authority contract for `/backend/v3/api`.

## Contract

- SDK family: `sdkwork-appbase-backend-sdk`
- API authority: `sdkwork-appbase-backend-api`
...
```bash
node sdks/sdkwork-appbase-backend-sdk/bin/generate-sdk.mjs
```

All generated language workspaces inherit the family name:

- `sdkwork-appbase-backend-sdk-typescript`
- `sdkwork-appbase-backend-sdk-dart`
...
Domain: platform
Capability: appbase-backend-sdk
