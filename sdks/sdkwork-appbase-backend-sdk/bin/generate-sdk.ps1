...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/appbase-backend-sdk" }
        "dart" { return "sdkwork_appbase_backend_sdk" }
        "flutter" { return "sdkwork_appbase_backend_sdk" }
        "python" { return "sdkwork-appbase-backend-sdk" }
        "go" { return "github.com/sdkwork/sdkwork-appbase-backend-sdk" }
        "java" { return "com.sdkwork:sdkwork-appbase-backend-sdk" }
        "kotlin" { return "com.sdkwork:sdkwork-appbase-backend-sdk" }
        "swift" { return "sdkwork-appbase-backend-sdk" }
        "csharp" { return "SDKWork.Appbase.BackendSdk" }
        "rust" { return "sdkwork-appbase-backend-sdk" }
        "php" { return "sdkwork/appbase-backend-sdk" }
        "ruby" { return "sdkwork-appbase-backend-sdk" }
        default { return "sdkwork-appbase-backend-sdk-$Language" }
    }
}
...
function Resolve-NamespaceArgs {
    ...
    switch ($Language) {
        "java" { return @("--namespace", "com.sdkwork.appbase.backend.sdk") }
        "kotlin" { return @("--namespace", "com.sdkwork.appbase.backend.sdk") }
        "csharp" { return @("--namespace", "SDKWork.Appbase.BackendSdk") }
        "php" { return @("--namespace", "SDKWork\Appbase\BackendSdk") }
        default { return @() }
    }
}
...
$AppbaseRoot = (Get-Item $FamilyRoot).Parent.Parent.FullName
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-appbase-backend-api.sdkgen.yaml"
$SdkName = "sdkwork-appbase-backend-sdk"
...
if (-not (Test-Path $InputPath)) {
    & node (Join-Path $AppbaseRoot "tools\generators\materialize-appbase-v3-openapi-boundaries.mjs")
}
if (-not (Test-Path $InputPath)) {
