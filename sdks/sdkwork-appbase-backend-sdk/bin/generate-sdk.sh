...
INPUT_PATH="${FAMILY_ROOT}/openapi/sdkwork-appbase-backend-api.sdkgen.yaml"
SDK_NAME="sdkwork-appbase-backend-sdk"
...
package_name() {
  case "$1" in
    typescript) echo "@sdkwork/appbase-backend-sdk" ;;
    dart|flutter) echo "sdkwork_appbase_backend_sdk" ;;
    python|swift|rust|ruby) echo "sdkwork-appbase-backend-sdk" ;;
    go) echo "github.com/sdkwork/sdkwork-appbase-backend-sdk" ;;
    java|kotlin) echo "com.sdkwork:sdkwork-appbase-backend-sdk" ;;
    csharp) echo "SDKWork.Appbase.BackendSdk" ;;
    php) echo "sdkwork/appbase-backend-sdk" ;;
    *) echo "sdkwork-appbase-backend-sdk-$1" ;;
  esac
}

namespace_args() {
  case "$1" in
    java|kotlin) printf '%s\n' "--namespace" "com.sdkwork.appbase.backend.sdk" ;;
