...
/** Iam oauth provider Catalog retrieve. */
  async retrieve(providerCode: string): Promise<AppbaseApiResult> {
    return this.client.get<AppbaseApiResult>(backendApiPath(`/iam/oauth/provider_catalog/${serializePathParameter(providerCode, { name: 'providerCode', style: 'simple', explode: false })}`));
  }
}
