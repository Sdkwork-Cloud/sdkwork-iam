...
Gem::Specification.new do |spec|
  spec.name = 'sdkwork-appbase-backend-sdk'
  spec.version = Sdkwork::BackendSdk::VERSION
  spec.authors = ['SDKWork Team']
  spec.summary = 'sdkwork-appbase-backend-sdk Ruby SDK'
  spec.description = 'sdkwork-appbase-backend-sdk Ruby SDK'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 3.0'
  spec.files = Dir.glob('lib/**/*') + ['README.md', 'sdkwork-appbase-backend-sdk.gemspec']
