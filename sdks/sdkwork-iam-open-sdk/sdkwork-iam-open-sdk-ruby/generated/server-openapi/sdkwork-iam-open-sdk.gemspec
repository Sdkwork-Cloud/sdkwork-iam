...
Gem::Specification.new do |spec|
  spec.name = 'sdkwork-iam-open-sdk'
  spec.version = Sdkwork::CustomSdk::VERSION
  spec.authors = ['SDKWork Team']
  spec.summary = 'sdkwork-iam-open-sdk Ruby SDK'
  spec.description = 'sdkwork-iam-open-sdk Ruby SDK'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 3.0'
  spec.files = Dir.glob('lib/**/*') + ['README.md', 'sdkwork-iam-open-sdk.gemspec']
