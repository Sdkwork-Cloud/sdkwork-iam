...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/iam-open-sdk" }
        "dart" { return "sdkwork_iam_open_sdk" }
        "flutter" { return "sdkwork_iam_open_sdk" }
        "python" { return "sdkwork-iam-open-sdk" }
        "go" { return "github.com/sdkwork/sdkwork-iam-open-sdk" }
        "java" { return "com.sdkwork:sdkwork-iam-open-sdk" }
        "kotlin" { return "com.sdkwork:sdkwork-iam-open-sdk" }
        "swift" { return "sdkwork-iam-open-sdk" }
        "csharp" { return "SDKWork.Iam.OpenSdk" }
        "rust" { return "sdkwork-iam-open-sdk" }
        "php" { return "sdkwork/iam-open-sdk" }
        "ruby" { return "sdkwork-iam-open-sdk" }
        default { return "sdkwork-iam-open-sdk-$Language" }
    }
}
...
function Resolve-NamespaceArgs {
    ...
    switch ($Language) {
        "java" { return @("--namespace", "com.sdkwork.iam.open.sdk") }
        "kotlin" { return @("--namespace", "com.sdkwork.iam.open.sdk") }
        "csharp" { return @("--namespace", "SDKWork.Iam.OpenSdk") }
        "php" { return @("--namespace", "SDKWork\\Iam\\OpenSdk") }
        default { return @() }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-iam-open-api.sdkgen.yaml"
$SdkName = "sdkwork-iam-open-sdk"
