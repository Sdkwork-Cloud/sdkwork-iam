...
```bash
go get github.com/sdkwork/sdkwork-iam-open-sdk
```
...
import (
    "fmt"
    "github.com/sdkwork/sdkwork-iam-open-sdk"
...
func main() {
    ...
    client := github.com/sdkwork/sdkwork-iam-open-sdk.NewSdkworkCustomClientWithConfig(cfg)
