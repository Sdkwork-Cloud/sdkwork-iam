...
import com.sdkwork.iam.open.sdk.model.*;
...
public class IamOauthApi {
    ...
    public AppbaseApiResult providerCallbacksHandleGet(String callbackPublicId) throws Exception {
        Object raw = client.request("GET", ApiPaths.customPath("/oauth/provider_callbacks/" + serializePathParameter(callbackPublicId, new PathParameterSpec("callbackPublicId", "simple", false)) + ""), null, null, null, null, true);
        return client.convertValue(raw, new TypeReference<AppbaseApiResult>() {});
    }

    /** Iam oauth provider Callbacks handle Post. */
    public AppbaseApiResult providerCallbacksHandlePost(String callbackPublicId, Map<String, Object> body) throws Exception {
        Object raw = client.request("POST", ApiPaths.customPath("/oauth/provider_callbacks/" + serializePathParameter(callbackPublicId, new PathParameterSpec("callbackPublicId", "simple", false)) + ""), body, null, null, "application/json", true);
        return client.convertValue(raw, new TypeReference<AppbaseApiResult>() {});
    }
