...
```bash
dotnet add package SDKWork.Appbase.AppSdk
```

Or add to your `.csproj`:

```xml
<PackageReference Include="SDKWork.Appbase.AppSdk" Version="1.0.0" />
```
...
var result = await client.Oauth.AccountLinksListAsync(query);
Console.WriteLine(result);
```
...
var result = await client.System.IamAccountBindingPolicyRetrieveAsync();
Console.WriteLine(result);
```
