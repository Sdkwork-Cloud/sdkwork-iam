...
```kotlin
implementation("com.sdkwork:sdkwork-appbase-app-sdk:1.0.0")
```
...
```kotlin
import com.sdkwork.appbase.app.sdk.SdkworkAppClient
...
val result = client.oauth.accountLinksList(params)
println(result)
```
...
val result = client.system.iamAccountBindingPolicyRetrieve()
println(result)
```
