...
```bash
pip install sdkwork-appbase-app-sdk
```

## Quick Start

```python
from sdkwork_appbase_app_sdk import SdkworkAppClient, SdkConfig
...
result = client.oauth.account_links.list(params)
print(result)
```
...
result = client.system.iam.account_binding_policy.retrieve()
print(result)
```
