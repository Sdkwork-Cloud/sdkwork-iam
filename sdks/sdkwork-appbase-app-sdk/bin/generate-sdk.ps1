...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/appbase-app-sdk" }
        "dart" { return "sdkwork_appbase_app_sdk" }
        "flutter" { return "sdkwork_appbase_app_sdk" }
        "python" { return "sdkwork-appbase-app-sdk" }
        "go" { return "github.com/sdkwork/sdkwork-appbase-app-sdk" }
        "java" { return "com.sdkwork:sdkwork-appbase-app-sdk" }
        "kotlin" { return "com.sdkwork:sdkwork-appbase-app-sdk" }
        "swift" { return "sdkwork-appbase-app-sdk" }
        "csharp" { return "SDKWork.Appbase.AppSdk" }
        "rust" { return "sdkwork-appbase-app-sdk" }
        "php" { return "sdkwork/appbase-app-sdk" }
        "ruby" { return "sdkwork-appbase-app-sdk" }
        default { return "sdkwork-appbase-app-sdk-$Language" }
    }
}
...
function Resolve-NamespaceArgs {
    ...
    switch ($Language) {
        "java" { return @("--namespace", "com.sdkwork.appbase.app.sdk") }
        "kotlin" { return @("--namespace", "com.sdkwork.appbase.app.sdk") }
        "csharp" { return @("--namespace", "SDKWork.Appbase.AppSdk") }
        "php" { return @("--namespace", "SDKWork\Appbase\AppSdk") }
        default { return @() }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-appbase-app-api.sdkgen.yaml"
$SdkName = "sdkwork-appbase-app-sdk"
