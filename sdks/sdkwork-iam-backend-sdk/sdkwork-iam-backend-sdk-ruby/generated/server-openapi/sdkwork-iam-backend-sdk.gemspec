...
Gem::Specification.new do |spec|
  spec.name = 'sdkwork-iam-backend-sdk'
  spec.version = Sdkwork::BackendSdk::VERSION
  spec.authors = ['SDKWork Team']
  spec.summary = 'sdkwork-iam-backend-sdk Ruby SDK'
  spec.description = 'sdkwork-iam-backend-sdk Ruby SDK'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 3.0'
  spec.files = Dir.glob('lib/**/*') + ['README.md', 'sdkwork-iam-backend-sdk.gemspec']
