...
use SDKWork\\Iam\\AppSdk\Models\SdkWorkCommandResponse;
use SDKWork\\Iam\\AppSdk\Models\SdkWorkResourceResponse;

final class AuthApi extends BaseApi
{
    /** Password Reset Requests create. */
    public function passwordResetRequestsCreate(array $body): ?SdkWorkResourceResponse
    {
    ...
    public function passwordResetsCreate(array $body): ?SdkWorkResourceResponse
    {
    ...
    public function registrationsCreate(array $body): ?SdkWorkResourceResponse
    {
    ...
    public function sessionsCurrentDelete(): mixed
    {
    ...
    public function sessionsCurrentRetrieve(): ?SdkWorkResourceResponse
    {
        $path = '/app/v3/api/auth/sessions/current';
    ...
    public function sessionsCurrentUpdate(?array $body = null): ?SdkWorkResourceResponse
    {
        $path = '/app/v3/api/auth/sessions/current';
        $payload = $body;
    ...
    public function sessionsLoginContextSelectionCreate(array $body): ?SdkWorkResourceResponse
    {
    ...
    public function sessionsOrganizationSelectionCreate(array $body): ?SdkWorkResourceResponse
    {
    ...
    /** Sessions refresh. */
    public function sessionsRefresh(array $body): ?SdkWorkCommandResponse
    {
