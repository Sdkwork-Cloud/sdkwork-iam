...
```bash
go get github.com/sdkwork/sdkwork-iam-app-sdk
```
...
import (
    "fmt"
    "github.com/sdkwork/sdkwork-iam-app-sdk"
...
func main() {
    ...
    client := github.com/sdkwork/sdkwork-iam-app-sdk.NewSdkworkAppClientWithConfig(cfg)
