...
- Local directories to inspect first when relevant: `.github/`, `docs/`, `packages/`, `scripts/`, `sdks/`, `specs/`.
...
- `pnpm run test:governance-node`: run the configured test suite for this scope.
- `pnpm run test:iam-standard-contracts`: run the configured test suite for this scope.
- `pnpm run test:iam-standard-governance`: run the configured test suite for this scope.
- `pnpm run test:user-center-standard-contracts`: run the configured test suite for this scope.
- `pnpm run test:watch`: run the configured test suite for this scope.
- `pnpm run test:workspace-vitest`: run the configured test suite for this scope.
