...
This directory is the local standards index for `@sdkwork/iam-pc-admin-tenant`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-pc-admin-tenant` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-iam-pc-admin-tenant` |
| Domain | `iam` |
