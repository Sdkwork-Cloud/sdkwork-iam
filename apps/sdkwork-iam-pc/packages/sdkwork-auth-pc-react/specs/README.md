# SDKWork Auth PC React Component Specs

This directory is the local standards index for `@sdkwork/auth-pc-react`.
...
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-auth-pc-react` |
| Domain | `iam` |
| Capability | `auth` |
