# SDKWork Auth Runtime PC React Component Specs

This directory is the local standards index for `@sdkwork/auth-runtime-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/auth-runtime-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-auth-runtime-pc-react` |
| Domain | `iam` |
