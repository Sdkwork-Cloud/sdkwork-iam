# SDKWork User PC React Component Specs

This directory is the local standards index for `@sdkwork/user-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/user-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-user-pc-react` |
| Domain | `iam` |
| Capability | `user` |
