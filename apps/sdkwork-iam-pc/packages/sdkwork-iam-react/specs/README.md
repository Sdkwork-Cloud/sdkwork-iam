# SDKWork Iam React Component Specs

This directory is the local standards index for `@sdkwork/iam-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-react` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-iam-react` |
| Domain | `iam` |
