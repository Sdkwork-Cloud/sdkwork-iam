# SDKWork Iam Core PC React Component Specs

This directory is the local standards index for `@sdkwork/iam-core-pc-react`.
...
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-iam-core-pc-react` |
| Domain | `iam` |
| Capability | `iam-core` |
