# SDKWork User Center PC React Component Specs

This directory is the local standards index for `@sdkwork/user-center-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/user-center-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-user-center-pc-react` |
| Domain | `iam` |
