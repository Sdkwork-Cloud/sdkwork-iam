# SDKWork Iam Permission PC React Component Specs

This directory is the local standards index for `@sdkwork/iam-pc-admin-permission`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-pc-admin-permission` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-iam-pc-admin-permission` |
| Domain | `iam` |
...
- `pnpm --filter @sdkwork/iam-pc-admin-permission typecheck`
