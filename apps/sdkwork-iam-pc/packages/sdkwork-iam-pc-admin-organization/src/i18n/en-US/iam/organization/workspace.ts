...
export const sdkworkIamOrganizationAdminMessages: SdkworkIamOrganizationAdminMessages = {
  ...
  memberships: {
    ...
    membershipKinds: { employee: "Employee", member: "Member", owner: "Owner", unknown: "Unknown" },
    statuses: { active: "Active", disabled: "Disabled", unknown: "Unknown" },
    table: { kind: "Membership type", member: "Member", role: "Role", status: "Status" }, titleTemplate: "{name} members",
  },
  notices: {
  ...
  organizations: {
    ...
    emptyDescription: "Create an organization to model operational ownership within a tenant.", emptyTitle: "No organizations found",
    ...
    table: { code: "Code", organization: "Organization", parent: "Parent", status: "Status" },
  },
  pagination: { next: "Next", pageSize: "Per page", previous: "Previous", total: "{total} items in total" },
  positions: {
    emptyDescription: "Positions created for this organization will appear here.", emptyTitle: "No positions",
    statuses: { active: "Active", disabled: "Disabled", unknown: "Unknown" },
    table: { department: "Department ID", position: "Position", status: "Status" }, titleTemplate: "{name} positions",
  },
  roleBindings: {
    emptyDescription: "Scoped role assignments for this organization will appear here.", emptyTitle: "No role bindings",
    principalFallback: "Principal",
  ...
  structure: {
    ...
    members: {
      ...
      member: "Member", noAvailableMembers: "Every available organization member is already assigned to this department.",
      ...
      searchPlaceholder: "Search member name or user ID", setPrimary: "Set as primary department", status: "Status",
      statuses: { active: "Active", disabled: "Disabled", unknown: "Unknown" }, userId: "User ID",
    },
    notices: {
