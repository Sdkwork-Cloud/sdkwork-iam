...
This directory is the local standards index for `@sdkwork/iam-pc-admin-organization`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-pc-admin-organization` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-iam-pc-admin-organization` |
| Domain | `iam` |
