# SDKWork User Center Validation PC React Component Specs

This directory is the local standards index for `@sdkwork/user-center-validation-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/user-center-validation-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-user-center-validation-pc-react` |
| Domain | `iam` |
