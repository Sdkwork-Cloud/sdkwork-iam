# SDKWork User Center Core PC React Component Specs

This directory is the local standards index for `@sdkwork/user-center-core-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/user-center-core-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-pc/packages/sdkwork-user-center-core-pc-react` |
| Domain | `iam` |
