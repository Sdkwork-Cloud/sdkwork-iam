# SDKWork Iam SDK Ports Component Specs

This directory is the local standards index for `@sdkwork/iam-sdk-ports`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-sdk-ports` |
| Type | `node-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-common/packages/sdkwork-iam-sdk-ports` |
| Domain | `iam` |
