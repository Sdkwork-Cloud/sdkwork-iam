# SDKWork Iam Rpc Contracts Component Specs

This directory is the local standards index for `@sdkwork/iam-rpc-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-rpc-contracts` |
| Type | `node-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-common/packages/sdkwork-iam-rpc-contracts` |
| Domain | `platform` |
| Capability | `app` |
...
- `node tools/generators/materialize-iam-rpc-proto-boundaries.mjs`
