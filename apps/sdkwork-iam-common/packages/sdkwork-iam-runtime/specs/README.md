# SDKWork Iam Runtime Component Specs

This directory is the local standards index for `@sdkwork/iam-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-runtime` |
| Type | `node-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-common/packages/sdkwork-iam-runtime` |
| Domain | `iam` |
