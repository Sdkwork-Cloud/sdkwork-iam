...
export function createIamBackendOauthService(
  ...
  return {
      accountLinks: {
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.accountLinks, "list", "iam.oauth.accountLinks.list", params),
        update: (...args: unknown[]) => callBackendOauth(backendOauth, (oauth) => oauth?.accountLinks, "update", "iam.oauth.accountLinks.update", ...args),
      },
      callbackEvents: {
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.callbackEvents, "list", "iam.oauth.callbackEvents.list", params),
      },
      claimMappings: {
        create: (...args: unknown[]) => callBackendOauth(backendOauth, (oauth) => oauth?.claimMappings, "create", "iam.oauth.claimMappings.create", ...args),
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.claimMappings, "list", "iam.oauth.claimMappings.list", params),
      ...
      clients: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.clients, "list", "iam.oauth.clients.list", params),
      ...
      diagnosticRuns: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.diagnosticRuns, "list", "iam.oauth.diagnosticRuns.list", params),
      ...
      flowConfigs: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.flowConfigs, "list", "iam.oauth.flowConfigs.list", params),
      ...
      grants: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.grants, "list", "iam.oauth.grants.list", params),
      },
      integrations: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.integrations, "list", "iam.oauth.integrations.list", params),
      ...
      operationalResources: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.operationalResources, "list", "iam.oauth.operationalResources.list", params),
        publishes: {
      ...
      operatorPlatforms: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.operatorPlatforms, "list", "iam.oauth.operatorPlatforms.list", params),
        preAuthorizations: {
      ...
      policies: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.policies, "list", "iam.oauth.policies.list", params),
      ...
      providerCatalog: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.providerCatalog, "list", "iam.oauth.providerCatalog.list", params),
      ...
      resourceAccounts: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.resourceAccounts, "list", "iam.oauth.resourceAccounts.list", params),
        miniProgramLoginChecks: {
      ...
      resourceAuthorizations: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.resourceAuthorizations, "list", "iam.oauth.resourceAuthorizations.list", params),
      ...
      scopeProfiles: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.scopeProfiles, "list", "iam.oauth.scopeProfiles.list", params),
      ...
      secrets: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.secrets, "list", "iam.oauth.secrets.list", params),
      },
      surfaces: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.surfaces, "list", "iam.oauth.surfaces.list", params),
      ...
      tenantBindings: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.tenantBindings, "list", "iam.oauth.tenantBindings.list", params),
      ...
      webhookConfigs: {
        ...
        list: (params?: Record<string, unknown>) => callBackendOauth(backendOauth, (oauth) => oauth?.webhookConfigs, "list", "iam.oauth.webhookConfigs.list", params),
