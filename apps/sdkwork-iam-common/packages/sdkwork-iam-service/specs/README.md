# SDKWork Iam Service Component Specs

This directory is the local standards index for `@sdkwork/iam-service`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-service` |
| Type | `node-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-common/packages/sdkwork-iam-service` |
| Domain | `iam` |
