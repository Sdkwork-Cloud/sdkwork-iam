# SDKWork Iam SDK Adapter Component Specs

This directory is the local standards index for `@sdkwork/iam-sdk-adapter`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-sdk-adapter` |
| Type | `node-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-common/packages/sdkwork-iam-sdk-adapter` |
| Domain | `iam` |
