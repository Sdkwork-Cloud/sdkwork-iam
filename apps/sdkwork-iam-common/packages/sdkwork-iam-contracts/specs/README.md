# SDKWork Iam Contracts Component Specs

This directory is the local standards index for `@sdkwork/iam-contracts`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-contracts` |
| Type | `node-package` |
| Root | `sdkwork-iam/apps/sdkwork-iam-common/packages/sdkwork-iam-contracts` |
| Domain | `iam` |
