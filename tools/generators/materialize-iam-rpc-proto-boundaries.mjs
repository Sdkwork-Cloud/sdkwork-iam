...
const syncTargets = [
  {
    ...
    target: 'apps/sdkwork-iam-common/packages/sdkwork-rpc-contracts/proto/sdkwork/common/v1',
  },
  {
    source: 'apis/rpc/iam/app/v3',
    target: 'apps/sdkwork-iam-common/packages/sdkwork-iam-rpc-contracts/proto/sdkwork/iam/app/v3',
  },
  {
    source: 'apis/rpc/iam/backend/v3',
    target: 'apps/sdkwork-iam-common/packages/sdkwork-iam-rpc-contracts/proto/sdkwork/iam/backend/v3',
  },
];
