# sdkwork-router-iam-app-api Component Specs

This directory is the local standards index for `sdkwork-router-iam-app-api`. Root SDKWork standards remain authoritative; local component specs can narrow this crate but must not duplicate or contradict root standards.
