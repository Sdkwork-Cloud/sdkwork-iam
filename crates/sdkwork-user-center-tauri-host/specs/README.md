# sdkwork-user-center-tauri-host Component Specs

This directory is the local standards index for `sdkwork-user-center-tauri-host`. Root SDKWork standards remain authoritative; local component specs can narrow this crate but must not duplicate or contradict root standards.
