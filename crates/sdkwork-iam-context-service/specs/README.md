# sdkwork-iam-context-service Component Specs

This directory is the local standards index for `sdkwork-iam-context-service`. Root SDKWork standards remain authoritative; local component specs can narrow this crate but must not duplicate or contradict root standards.
