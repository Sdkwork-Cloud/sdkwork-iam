# sdkwork-router-iam-open-api Component Specs

This directory is the local standards index for `sdkwork-router-iam-open-api`. Root SDKWork standards remain authoritative; local component specs can narrow this crate but must not duplicate or contradict root standards.

## Component

| Field | Value |
| --- | --- |
| Name | `sdkwork-router-iam-open-api` |
| Type | `rust-route-crate` |
| Root | `sdkwork-appbase/crates/sdkwork-router-iam-open-api` |
| Domain | `iam` |
| Capability | `iam` |
| Languages | `rust` |
