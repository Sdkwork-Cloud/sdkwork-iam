# sdkwork-routes-iam-open-api Component Specs

This directory is the local standards index for `sdkwork-routes-iam-open-api`. Root SDKWork standards remain authoritative; local component specs can narrow this crate but must not duplicate or contradict root standards.

## Component

| Field | Value |
| --- | --- |
| Name | `sdkwork-routes-iam-open-api` |
| Type | `rust-route-crate` |
| Root | `sdkwork-iam/crates/sdkwork-routes-iam-open-api` |
| Domain | `iam` |
| Capability | `iam` |
| Languages | `rust` |
...
- [WEB_FRAMEWORK_SPEC.md](../../../../sdkwork-specs/WEB_FRAMEWORK_SPEC.md): Mandatory sdkwork-web-framework integration for HTTP surfaces.
...
- `sdkwork_routes_iam_open_api::open_routes`
- `sdkwork_routes_iam_open_api::sdkwork_iam_open_api_routes`
- `sdkwork_routes_iam_open_api::build_sdkwork_iam_open_api_router`
- `sdkwork_routes_iam_open_api::build_sdkwork_iam_open_api_router_from_env`
