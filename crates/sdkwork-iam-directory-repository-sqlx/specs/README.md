# sdkwork-iam-directory-repository-sqlx Component Specs

This directory is the local standards index for `sdkwork-iam-directory-repository-sqlx`. Root SDKWork standards remain authoritative; local component specs can narrow this crate but must not duplicate or contradict root standards.
