//! Application manifest types and parsing for embedded IAM tenant application bootstrap.
//!
...
/// Options for embedded application bootstrap.
...
/// Runtime binding for multi-surface applications (e.g. PC + H5 + Flutter).
