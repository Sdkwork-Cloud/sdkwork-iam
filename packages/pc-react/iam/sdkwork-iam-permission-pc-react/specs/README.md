...
This directory is the local standards index for `@sdkwork/iam-permission-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-permission-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/iam/sdkwork-iam-permission-pc-react` |
| Domain | `iam` |
