# SDKWork Iam Tenant PC React Component Specs

This directory is the local standards index for `@sdkwork/iam-tenant-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-tenant-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/iam/sdkwork-iam-tenant-pc-react` |
| Domain | `iam` |
...
- `pnpm --filter @sdkwork/iam-tenant-pc-react typecheck`
