# SDKWork Iam Organization PC React Component Specs

This directory is the local standards index for `@sdkwork/iam-organization-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/iam-organization-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-appbase/packages/pc-react/iam/sdkwork-iam-organization-pc-react` |
| Domain | `iam` |
...
- `pnpm --filter @sdkwork/iam-organization-pc-react typecheck`
