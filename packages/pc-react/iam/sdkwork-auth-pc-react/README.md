...
This keeps app packages limited to constants, route base paths, and branding metadata while the standard auth contract stays centralized in `sdkwork-appbase`.
