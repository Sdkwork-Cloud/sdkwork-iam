...
export const SDKWORK_IAM_CAPABILITIES = [
  ...
  capability(
    ...
    ["iam"],
    ["apiKey"],
    ["apiKeys.list", "apiKeys.revoke", "accessCredentials.create", "applications.register", "tenantApplications.provision", "tenantApplications.update", "tenantApplications.enable"],
  ),
  capability(
    "securityAudit",
    ["iam"],
