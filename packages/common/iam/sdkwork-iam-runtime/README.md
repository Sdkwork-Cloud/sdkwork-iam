...
Applications provide the generated `@sdkwork/appbase-app-sdk` client as `clients.appbaseApp`.
...
Applications may provide `@sdkwork/appbase-backend-sdk` as `clients.appbaseBackend`
...
```ts
import { createClient as createAppbaseAppClient } from "@sdkwork/appbase-app-sdk";
import { createClient as createAppbaseBackendClient } from "@sdkwork/appbase-backend-sdk";
